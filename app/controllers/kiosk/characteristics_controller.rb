module Kiosk
  class CharacteristicsController < ::CharacteristicsController
    ...
    def update
      Rails.logger.info "Kiosk::CharacteristicsController update"
    ...
    def new
      ...
      Rails.logger.info "Kiosk::CharacteristicsController new"
    ...
    def header
      Rails.logger.info "Kiosk::CharacteristicsController header"
